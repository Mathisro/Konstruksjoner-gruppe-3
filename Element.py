...
class Element:
    ...
    def __init__(self, elemRow, n, PunktOb):
        self.elem_n = n # Elementnummer
        self.P1 = PunktOb[elemRow[0]] # Globalt knutepunkt av typen Punkt for ende 1
        self.P2 = PunktOb[elemRow[1]] # Globalt knutepunkt av typen Punkt for ende 2
        ...
        self.angleElem = np.arctan2((self.P2[1]-self.P1[1])/(self.P2[1]-self.P1[1]))
